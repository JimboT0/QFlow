...
const Testimonial = () => {
    ...
    return (
        <>
            <section className="pt-20 pb-20 lg:pt-[120px] lg:pb-[120px] bg-white">
                    ...
                    <Swiper slidesPerView={1} ref={sliderRef}>
                        ...
                        <div className="absolute z-50 left-0 right-0 bottom-0 flex items-center justify-center lg:pl-[120px] 2xl:pl-0">
                            <div className="prev-arrow cursor-pointer" onClick={handlePrev}>
                                <button className="text-white hover:bg-primary shadow-input mx-1 flex h-12 w-12 items-center justify-center rounded-full bg-gray-800 transition-all hover:text-white">
                                    <svg
                                        width="15"
                                        height="13"
                                        viewBox="0 0 15 13"
                ...
                <div className="w-full items-center md:flex">
                    ...
                    <div className="w-full">
                        <div>
                            ...
                            <p className="text-gray-800 mb-11 text-base font-medium italic sm:text-lg">
                                {details}
                            </p>
                            <h4 className="text-gray-800 text-xl font-semibold">{name}</h4>
                            <p className="text-gray-800 text-base">{position}</p>
                        </div>
                    </div>
                </div>
            </div>
